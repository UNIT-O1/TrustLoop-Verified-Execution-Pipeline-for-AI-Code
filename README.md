...
* Sorting ensures order and element preservation
...
<p align="center">
  <i>Verification pipelines · Constraint solving · Counterexample detection</i>
</p>
...
(Modify based on your actual entry file)
...
* 🧠 Combines testing and formal methods
